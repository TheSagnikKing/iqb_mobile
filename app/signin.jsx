...
const Signin = () => {
  ...
  console.log("EXPO PUSH TOKEN FROM SIGN IN ", expoPushToken)
  ...
  //Notification code End =========
    ...
    const signinClicked = async () => {
        ...
        if (email == "" && password == "") {
            ...
            dispatch(signinAction(email, password, currentSalonInfo?.[0]?.id, router, "iqueuelogin.php", rememberdatatrue, expoPushToken))
        }
    }
